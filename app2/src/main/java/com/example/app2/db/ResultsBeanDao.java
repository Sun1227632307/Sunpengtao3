...
*/
public class ResultsBeanDao extends AbstractDao<ResultsBean, Void> {
    ...
    public static class Properties {
        public final static Property Read = new Property(0, boolean.class, "read", false, "READ");
    ...
    protected final void bindValues(DatabaseStatement stmt, ResultsBean entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getRead() ? 1L: 0L);
    ...
    public ResultsBean readEntity(Cursor cursor, int offset) {
        ResultsBean entity = new ResultsBean( //
            cursor.getShort(offset + 0) != 0, // read
    ...
    public void readEntity(Cursor cursor, ResultsBean entity, int offset) {
        entity.setRead(cursor.getShort(offset + 0) != 0);
    ...
    @Override
    protected final Void updateKeyAfterInsert(ResultsBean entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(ResultsBean entity) {
        return null;
    }
